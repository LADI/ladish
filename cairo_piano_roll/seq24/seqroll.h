...
class seqroll : public Gtk::DrawingArea
{
 ...
 private: 
    ...
    void draw_events_on(cairo_t* cairo);
 ...
 public:
	...
	void draw_background_on(cairo_t * cairo, int clip_x, int clip_y, int clip_w, int clip_h);
    void draw_selection_on(cairo_t* cairo);
	void draw_selection_on_window();
    void draw_progress_on(cairo_t* cairo, bool clear_old);
