...
void
lash_exec_params_set_working_dir (lash_exec_params_t * params, const char * working_dir)
{
...
void
lash_exec_params_set_args        (lash_exec_params_t * params, int argc, const char * const * argv)
{
  int i;
