...
static void print_help () {
  ...
  printf("     --lash-server <host>  Connect to server running on <host>\n");
...
int main (int argc, char ** argv)
{
  ...
  lash_client = lash_init (lash_args, "LASH Control", LASH_Server_Interface|LASH_Terminal, LASH_PROTOCOL (2,0));
