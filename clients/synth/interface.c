...
gboolean
toggle_button_bar_cb (GtkWidget *widget, GdkEventButton *event, gpointer data)
{
  GtkWidget * handle;
...
gboolean
envelope_display_expose_cb (GtkWidget *widget, GdkEventExpose *event, gpointer data)
{
  GdkDrawable * window;
  GdkGC * gc;
  gint envelope_width;
  ...
  sustain_width = (envelope_width / total) * (total - attack - decay - release);
...
interface_main (void * data)
{
  ...
  modulation_range = gtk_hscale_new_with_range (0.0, MODULATION_UPPER, MODULATION_UPPER/1000);
  ...
  gain_range = gtk_hscale_new_with_range (0.0, GAIN_UPPER, GAIN_UPPER/1000);
...
/*  gtk_widget_set_size_request (adsr_display, 300, 130); */
  ...
  attack_range = gtk_hscale_new_with_range (0.0, ENVELOPE_UPPER, ENVELOPE_UPPER/1000);
  ...
  decay_range = gtk_hscale_new_with_range (0.0, ENVELOPE_UPPER, ENVELOPE_UPPER/1000);
  ...
  sustain_range = gtk_hscale_new_with_range (0.0, ENVELOPE_UPPER, ENVELOPE_UPPER/1000);
  ...
  release_range = gtk_hscale_new_with_range (0.0, ENVELOPE_UPPER, ENVELOPE_UPPER/1000);
